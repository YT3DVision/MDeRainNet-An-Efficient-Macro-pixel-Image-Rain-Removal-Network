...
def prepare_train_data_syn(data_path, patch_size, stride, angs):
    # train
    if os.path.exists(os.path.join(data_path, 'train_target_syn.h5')) == 0 and os.path.exists(
            os.path.join(data_path, 'train_input_syn.h5')) == 0:
        print('process training data_syn')
        input_path = os.path.join(data_path, 'input')
        target_path = os.path.join(data_path, 'gt')

        save_target_path = os.path.join(data_path, 'train_target_syn.h5')
        save_input_path = os.path.join(data_path, 'train_input_syn.h5')
        ...
        target_h5f.close()
        input_h5f.close()
        print('training set_syn, # samples %d\n' % train_num)


class Train_Dataset_syn(udata.Dataset):
    def __init__(self, data_path='.'):
        super(Train_Dataset_syn, self).__init__()

        self.data_path = data_path

        target_path = os.path.join(self.data_path, 'train_target_syn.h5')
        input_path = os.path.join(self.data_path, 'train_input_syn.h5')
...
def prepare_train_data_real(data_path, patch_size, stride, angs):
    # train
    if os.path.exists(os.path.join(data_path, 'train_residual_real.h5')) == 0 and os.path.exists(
            os.path.join(data_path, 'train_input_real.h5')) == 0:
        print('process training data_real')
        input_path = os.path.join(data_path, 'input')
        target_path = os.path.join(data_path, 'residual')

        save_target_path = os.path.join(data_path, 'train_residual_real.h5')
        save_input_path = os.path.join(data_path, 'train_input_real.h5')
        ...
        target_h5f.close()
        input_h5f.close()
        print('training set_real, # samples %d\n' % train_num)


class Train_Dataset_real(udata.Dataset):
    def __init__(self, data_path='.'):
        super(Train_Dataset_real, self).__init__()

        self.data_path = data_path

        target_path = os.path.join(self.data_path, 'train_residual_real.h5')
        input_path = os.path.join(self.data_path, 'train_input_real.h5')
